...
MAKECMD         = "C:/apps/MATLAB/R2021b/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := TRAS_PID_Cross_demoNocNaukowcow
MODULES              := rt_matrx.c rt_printf.c TRAS_PID_Cross_demoNocNaukowcow_data.c TRAS_PID_Cross_demoNocNaukowcow_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c TRAS_AnalogInput.c TRAS_BitstreamVersion.c TRAS_Encoder.c TRAS_PWM.c TRAS_PWMPrescaler.c TRAS_PWMTherm.c TRAS_ResetEncoder.c TRAS_ThermFlag.c
MAKEFILE             := TRAS_PID_Cross_demoNocNaukowcow.mk
MATLAB_ROOT          := C:/apps/MATLAB/R2021b
MATLAB_BIN           := C:/apps/MATLAB/R2021b/bin
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
...
SLDRTDIR             := C:/apps/MATLAB/R2021b/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := TRAS_PID_Cross_demoNocNaukowcow_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/CP_pon1130;D:/CP_pon1130/TRAS_PID_Cross_demoNocNaukowcow_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
...
CPPSRCDIRS := $(RELATIVE_PATH_TO_ANCHOR) $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/toolbox/Tras/DevDriv $(MATLAB_ROOT)/rtw/c/src $(MATLAB_ROOT)/simulink/src $(MATLAB_ROOT)/rtw/c/src/ext_mode/common 
