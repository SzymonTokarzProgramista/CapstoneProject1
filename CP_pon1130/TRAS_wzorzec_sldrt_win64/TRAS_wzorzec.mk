...
MODEL                := TRAS_wzorzec
MODULES              := rt_matrx.c rt_printf.c TRAS_wzorzec_data.c TRAS_wzorzec_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c TRAS_AnalogInput.c TRAS_BitstreamVersion.c TRAS_Encoder.c TRAS_PWM.c TRAS_PWMPrescaler.c TRAS_PWMTherm.c TRAS_ResetEncoder.c TRAS_ThermFlag.c
MAKEFILE             := TRAS_wzorzec.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := TRAS_wzorzec_ref.rsp
...
# additional includes
REQ_INCLUDES += ;D:/CP_pon1130;D:/CP_pon1130/TRAS_wzorzec_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
