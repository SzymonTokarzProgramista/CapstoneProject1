...
#ifndef RTW_HEADER_TRAS_wzorzec_h_
#define RTW_HEADER_TRAS_wzorzec_h_
#include <string.h>
#include <stddef.h>
#ifndef TRAS_wzorzec_COMMON_INCLUDES_
#define TRAS_wzorzec_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* TRAS_wzorzec_COMMON_INCLUDES_ */

#include "TRAS_wzorzec_types.h"
...
#define TRAS_wzorzec_rtModel           RT_MODEL_TRAS_wzorzec_T
...
typedef struct {
  ...
  real_T Rst;                          /* '<Root>/Reset Encoders' */
  real_T Filtered;                     /* '<Root>/Pitch Control FIlter' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } AngleScope_PWORK;                  /* '<Root>/Angle Scope' */

  struct {
    void *LoggedData[3];
  } ControlScope_PWORK;                /* '<Root>/Control Scope' */
  ...
  struct {
    void *LoggedData[2];
  } RPMScope_PWORK;                    /* '<Root>/RPM Scope' */
} DW_TRAS_wzorzec_T;

/* Backward compatible GRT Identifiers */
#define rtB                            TRAS_wzorzec_B
#define BlockIO                        B_TRAS_wzorzec_T
#define rtP                            TRAS_wzorzec_P
#define Parameters                     P_TRAS_wzorzec_T
#define rtDWork                        TRAS_wzorzec_DW
#define D_Work                         DW_TRAS_wzorzec_T

/* Parameters (default storage) */
struct P_TRAS_wzorzec_T_ {
...
extern P_TRAS_wzorzec_T TRAS_wzorzec_P;

/* Block signals (default storage) */
extern B_TRAS_wzorzec_T TRAS_wzorzec_B;

/* Block states (default storage) */
extern DW_TRAS_wzorzec_T TRAS_wzorzec_DW;

/* Model entry point functions */
extern void TRAS_wzorzec_initialize(void);
extern void TRAS_wzorzec_output(void);
extern void TRAS_wzorzec_update(void);
extern void TRAS_wzorzec_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern TRAS_wzorzec_rtModel *TRAS_wzorzec(void);
...
extern RT_MODEL_TRAS_wzorzec_T *const TRAS_wzorzec_M;
 ...
 *
 * '<Root>' : 'TRAS_wzorzec'
 * '<S1>'   : 'TRAS_wzorzec/Repeating Sequence'
 * '<S2>'   : 'TRAS_wzorzec/TRAS'
 */
#endif                                 /* RTW_HEADER_TRAS_wzorzec_h_ */
